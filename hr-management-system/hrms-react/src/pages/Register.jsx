...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    // Demo only — no backend persistence yet. Simulates network latency.
    ...
    <div className="login-page">
      <div className="login-card" style={{ maxWidth: "460px" }}>
        ...
        <div className="login-demo-credentials" style={{ marginTop: "var(--sp-5)" }}>
          <p>
            <strong>Note:</strong> This is a UI preview only. Account creation is not yet connected to a backend — use the demo credentials on the Sign In page to explore the system.
          </p>
        </div>
      </div>
    </div>
